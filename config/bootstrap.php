...
Cache::write('AdminRoles', [ 'admin.root'=>'admin.root', 'user.tenant'=>'user.tenant', 'user.landlord'=>'user.landlord' ]);
...
Cache::write('ROLES', [
	'admin.root'=>[//     (technical top level admin) 
        ...
        'expenses'=>['create'=>1, 'read'=>1, 'update'=>1, 'delete'=>1, 'allids'=>1],
        'services'=>['create'=>1, 'read'=>1, 'update'=>1, 'delete'=>1, 'allids'=>1],
        'packages'=>['create'=>1, 'read'=>1, 'update'=>1, 'delete'=>1, 'allids'=>1],
        'banks'=>['create'=>1, 'read'=>1, 'update'=>1, 'delete'=>1, 'allids'=>1],
