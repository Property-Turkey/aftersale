...
$admin_menu=[
       ...
       "icon"=>"user-secret",
       "roles"=>["admin.root", "admin.portfolio", "admin.callcenter", "admin.supervisor", "admin.admin", "admin.content"],
       "active"=>"/services/index,/services/save,/services/view",
       "sub" => [
              ["name"=>"all", "url" => ["services", "index", ""]],
          ]
      ],
      ["name"=>"packages",
      "icon"=>"book",
      ...
      "sub" => [
             ["name"=>"all", "url" => ["packages", "index", ""]],
         ]
     ],
     ["name"=>"expenses",
     "icon"=>"user-secret",
     "roles"=>["admin.root", "admin.portfolio", "admin.callcenter", "admin.supervisor", "admin.admin", "admin.content"],
     "active"=>"/expenses/index,/expenses/save,/expenses/view",
     "sub" => [
            ["name"=>"all", "url" => ["Expenses", "index", ""]],
        ]
    ],
    ["name"=>"banks",
    "icon"=>"file-text-o",
...
//         ]
  ...
  "icon"=>"user-secret",
  "roles"=>["admin.root", "admin.portfolio", "admin.callcenter", "admin.supervisor", "admin.admin", "admin.content"],
  "active"=>"/messages/index,/messages/save,/messages/view",
  "sub" => [
