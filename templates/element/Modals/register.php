            ...
            <div class="modal-body row" id="accordion">
                ...
                <div class="col-12 ">
                    <form method="post" novalidate="novalidate" ng-submit="doRegister();" 
                        ...
                        <div class="col-12">
                        <div class="col-12">
                <h5 class="modal-title col-12"><?= __('user_role') ?></h5>
    <div class="form-check">
        <input class="form-check-input" type="checkbox" id="landlordCheckbox" ng-model="userRole.landlord">
        <label class="form-check-label" for="landlordCheckbox">
            Landlord
        </label>
    </div>
    <div class="form-check">
        <input class="form-check-input" type="checkbox" id="tenantCheckbox" ng-model="userRole.tenant">
        <label class="form-check-label" for="tenantCheckbox">
            Tenant
        </label>
    </div>
</div>
