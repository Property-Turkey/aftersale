                    ...
                    <div class="x_content"> 
                        <div class="grid ">
                            ...
                            <div class="grid_header row">
                                ...
                                <div class="col-sm-1 col">
                                    <?=$this->element('colActions', ['url'=>'users/index/', 'col'=>'email', 'search'=>'email'])?> 
                                    <?=__('email')?> </div>
                                                            
                                <div class="col-sm-1 col">
                                    <?=$this->element('colActions', ['url'=>'users/index/', 'col'=>'address', 'search'=>'address'])?> 
                                    <?=__('address')?> </div>

                                <div class="col-sm-1 col">
                                    <?=$this->element('colActions', ['url'=>'users/index/', 'col'=>'mobile', 'search'=>'mobile'])?> 
                                    <?=__('mobile')?> </div>
                                ...
                                <div class="col-sm-1 col">
                                    <?=$this->element('colActions', ['url'=>'users/index/', 'col'=>'user_configs', 'search'=>'user_configs'])?> 
                                    <?=__('user_configs')?> </div>

                                <div class="col-sm-1 col">
                                    <?=$this->element('colActions', ['url'=>'users/index/', 'col'=>'stat_created', 'search'=>'stat_created'])?> 
                                    <?=__('stat_created')?> </div>
                            ...
                            <div class="grid_row row" ng-repeat="itm in lists.users">
                                ...
                                <div class="col-4 hideWeb grid_header"><?=__('email')?></div>
                                <div class="col-md-1 col-8" ng-bind-html="DtSetter('', itm.email)"></div>

                                <div class="col-4 hideWeb grid_header"><?=__('address')?></div>
                                <div class="col-md-1 col-8" ng-bind-html="DtSetter('', itm.address)"></div>

                                <div class="col-4 hideWeb grid_header"><?=__('mobile')?></div>
