                            ...
                            <div class="grid_row row" ng-repeat="itm in lists.categories">
                                ...
                                <div class="col-sm-1 hideMobSm grid_header">
                                    <label class="mycheckbox chkb">
                                        ...
                                        <span></span> {{ itm.id }} <a href="<?= $app_folder ?>/admin/categories/index/{{itm.id}}"><i class=""></i></a>
                                    </label>
                                </div>
                                ...
                                <div class="col-md-4 col-8">
                                    <i class="fa "></i> {{ itm.category_name }}
                                </div>
                                ...
                                <div class="col-md-2 col-8">
                                    <a href="<?= $app_folder ?>/admin/categories/index/{{itm.parent_id}}">[{{ itm.parent_id }}]{{itm.parent_category.category_name}}</a>
                                </div>
